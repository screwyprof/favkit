...
mod tests {
    ...
    fn test_section_items() {
        ...
        let favorites = vec![
            ...
            SidebarItem::new(Target::Applications(PathBuf::from("/Applications")), "Applications"),
            SidebarItem::new(Target::Downloads(PathBuf::from("/Users/test/Downloads")), "Downloads"),
        ];
